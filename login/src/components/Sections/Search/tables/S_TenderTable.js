...
export default function A_TenderTable(props) {
  ...
  const [openDecisionPopup, setOpenDecisionPopup] = React.useState(false);
  ...
  return (
    ...
    <Container maxWidth="lg" className={classes.container}>
      ...
      <Popup
        title="Tender Decision"
        openPopup={openDecisionPopup}
        setOpenPopup={setOpenDecisionPopup}
      >
      <TenderDecision {...props} edit={edit} recordForEdit = {recordForEdit} />
      </Popup>
    </React.Fragment>
  );
}
